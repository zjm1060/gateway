...
void config_init(void)
{
	...
	strcpy(opts.host,config_get_string("tcp://lhloao.com:1883","config.device.host"));
	...
	strcpy(opts.ssl.CAFile,config_get_string("","config.ssl.CAFile"));
	strcpy(opts.ssl.clientKeyFile,config_get_string("","config.ssl.clientKeyFile"));
	strcpy(opts.ssl.clientPassFile,config_get_string("","config.ssl.clientPassFile"));
	strcpy(opts.ssl.clientKeyPassword,config_get_string("","config.ssl.clientKeyPassword"));
}
//
